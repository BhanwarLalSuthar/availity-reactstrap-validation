  ...
  render() {
    ...
    return /*#__PURE__*/_jsxs(FormGroup, {
      ...
      children: [/*#__PURE__*/_jsx(Input, _objectSpread(_objectSpread({
        ...
        id: id || "radio-".concat(groupProps.name, "-").concat(this.props.value),
        className: classes,
        ...
        check: true,
        for: id || "radio-".concat(groupProps.name, "-").concat(this.props.value),
        children: this.props.label
      })]
    });
  }
}
_defineProperty(AvRadio, "contextTypes", Object.assign({}, AvInput.contextTypes, {
  Group: PropTypes.object.isRequired
}));
_defineProperty(AvRadio, "propTypes", radioPropTypes);